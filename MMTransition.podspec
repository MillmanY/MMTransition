#
# Be sure to run `pod lib lint MMTransition.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  s.name             = 'MMTransition'
  s.version          = '0.1.0'
  s.summary          = 'A short description of MMTransition.'
...
TODO: Add long description of the pod here.
  ...
  s.source_files = 'MMTransition/Classes/**/*'
  
  # s.resource_bundles = {
  #   'MMTransition' => ['MMTransition/Assets/*.png']
  # }
